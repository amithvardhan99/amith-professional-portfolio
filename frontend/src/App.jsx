    ...
    <div className="site-shell">
      ...
      <header className="nav-wrap">
        <nav className="nav container">
          <a href="#top" className="brand" onClick={() => setMenuOpen(false)}>
            ...
            <span>
              AMITH<span className="brand-dot">.</span>
            </span>
          </a>
      ...
      <main id="top">
        <section className="hero container">
          ...
          {/* Large centered name above the existing hero content */}
          <motion.h2
            className="hero-name"
        ...
        <section className="section container" id="about">
          ...
          <div className="about-grid">
            ...
            <Reveal
              className="about-highlights glass-card"
              delay={0.08}
            >
        ...
        <section className="section container" id="education">
          ...
          <div className="education-grid">
            ...
            <Reveal
              className="credentials-panel glass-card"
              delay={0.1}
            >
              ...
              <div className="panel-heading awards-heading">
                <Trophy size={18} />
